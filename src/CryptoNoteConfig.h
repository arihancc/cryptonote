...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x791e;
...
const char     CRYPTONOTE_NAME[]                             = "Talon";
...
const int      P2P_DEFAULT_PORT                              = 50012;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 50013;
